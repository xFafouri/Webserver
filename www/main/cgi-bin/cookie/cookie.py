...
check_path("./www/main/cgi-bin/cookie/database")
...
def get_new_user_theme(user_id):
    ...
    try:
        with open(f"./www/main/cgi-bin/cookie/database/{user_id}.txt", "w") as file:
            file.write(newTheme)
...
def get_user_theme(user_id):
    try:
        with open(f"./www/main/cgi-bin/cookie/database/{user_id}.txt", "r") as file:
...
<body>
    <div class="container">
        <h2>Cookie Page</h2>
        <form action="/cgi-bin/cookie/cookie.py" method="post">
